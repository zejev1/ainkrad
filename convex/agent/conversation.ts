...
function agentPrompts(
  ...
  const prompt = [
    ...
    `If the other participant speaks Russian, always reply in natural Russian.`,
    `If the other participant speaks English, reply in English.`,
    `Never claim that you do not understand Russian.`,
    `If there is no clear language context yet, use Russian by default.`,
    `Keep names, personality, memories, relationships, and goals intact regardless of the language being used.`,
  ];
